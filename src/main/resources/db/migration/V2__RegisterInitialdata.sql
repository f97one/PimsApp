...
-- ユーザー
INSERT INTO USERS (USERNAME, PASSWORD, DISPLAY_NAME, MAIL_ADDRESS, ENABLED, AUTHORITY) VALUES ('admin', '$2a$10$eE6cp8dD.I7YHfA/9n75RuUIlEPfKbtx0imJXJYAicd7c9aXu4RZa', 'PIMS Admin', 'pims@example.net', 'true', 'authority_admin');
